...
const PropertyLocation = ({ propertyId }: PropertyDetailsProps) => {
    ...
    useEffect(() => {
        ...
        const map = new mapboxgl.Map({container: mapContainerRef.current!, style: "placeholder", center: [property.location.coordinates.longitude, property.location.coordinates.latitude], zoom: 14});
