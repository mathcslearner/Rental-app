...
export const getProperties = async (req: Request, res: Response): Promise<void> => {
    try {
        const {
            favoriteIds, priceMin, priceMax, beds, baths, propertyType, squareFeetMin, squareFeetMax, amenities, availableFrom, latitude, longitude
        } = req.query
        ...
        if (latitude && longitude) {
            ...
            whereConditions.push(Prisma.sql`ST_DWithin(l.coordinates::geometry, ST_SetSRID(SR_MakePoint(${lng}, ${lat}), 4326), ${degrees})`)
        }
            ...
            SELECT
                ...
                json_build_object(
                    ...
                    'coordinates', json_build_object(
                        ...
                        'latitude', ST_Y(l."coordinates"::geomtry)
                    )
                ) as location
            FROM "Property" p
